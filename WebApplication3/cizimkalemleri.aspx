<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="cizimkalemleri.aspx.cs" Inherits="WebApplication3.cizimkalemleri" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">

    <div class="vitrin" style="padding-top:5px;">
    <asp:Repeater ID="Repeater_vitrin" runat="server">
        <ItemTemplate>
			...
			<%--AL BAŞLAT DENE ANLAMADIGIN YERİ SORARSIN ARAMA KISMI VE ÜYE OL - GİRİŞ KISMI EKSİK--%>
         </div>
                </div>
        </ItemTemplate>
    </asp:Repeater>
